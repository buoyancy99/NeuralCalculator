...
for i in range(1000):
    batch = mathset.train.next_batch(200)
...
print "test accuracy %g"%accuracy.eval(feed_dict={x: mathset.test.images, y_: mathset.test.labels, keep_prob: 1.0})
print "Saving"
save_path=saver.save(sess,"./Models/full.ckpt")
